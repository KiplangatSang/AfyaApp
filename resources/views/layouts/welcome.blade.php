        ...
        <nav class="navbar navbar-expand-md navbar-inverse shadow-sm sticky-top navbar-dark bg-dark p-2">
            <div class="container-fluid ">
                <a class="navbar-brand d-flex" href="{{ url('/home') }}">
                    <div class="p-2"><img src="{{url('images/logo.png')}}" style="height:35px;border-right:1px solid #000 " class="pr-3"></div>
                    <div class="pl-1">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto ">
                        ...
                        <div class=" fixed top-0 right-0 px-6 py-4 sm:block">
                            @auth
                            @else
                            <a href="{{ route('login') }}" class="btn btn-info text-sm text-gray-300 dark:text-gray-900 ">Login <i class="fa-solid fa-right-to-bracket"></i></a>
                            @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="btn btn-primary ml-4 text-sm  text-gray-300 dark:text-gray-900 underline">Register <i class="fa-regular fa-file"></i></a>
                            @endif
                            @endauth
                        </div>
                        @endif
            ...
            <div class="container text-center text-md-start mt-5">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                        ...
                        <p>
                            {{ config("app.name") }} is a digital application that helps to conect patients to their personal doctors with ease and efficiency without them leaving for the hospital unless required. It makes the booking of appointments easier asn seemless for the patient
                        </p>
                    </div>
                    <!-- Grid column -->
                    ...
                    <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                        ...
                        <hr class="mb-4 mt-0 d-inline-block mx-auto" style="width: 60px; background-color: #7c4dff; height: 2px" />
                        <p><i class="fas fa-location-dot mr-3"></i> Nairobi, Kenya , Nairobi County</p>
                        <p><i class="fas fa-envelope mr-3"></i>{{ config("app.name") }}@gmail.com</p>
                        <p><i class="fas fa-phone mr-3"></i> +254 712 345678</p>
                        <p><i class="fas fa-print mr-3"></i> +254 712 345678</p>
                    </div>
                    <!-- Grid column -->
                </div>
                <!-- Grid row -->
