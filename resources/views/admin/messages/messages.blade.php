            ...
            <section class="message message-container overflow-auto" id="chat-section">
                <div class="parent">
                    ...
                    <div class="container">
                        ...
                        <span class="time-right" id="message_created_at">{{ $message->created_at->format('d-m-Y H:i')
                            }}</span>
                    </div>
                    @if ($message->replies)
                    ...
                    <div class="container darker">
                        <div class="col-md-3 col-xl-2"><img class="logo w-25" src="{{ url('images/logo.png') }}"
                                alt="Avatar" class="right" style="width: 100%" /></div>
                        <p><strong>{{ $reply->key ?? ""}} {{ $message->doctor->user->username ?? "Admin" }}</strong>
                        </p>
                        <p>{{ $reply->message }}</p>
                    ...
                    <div class="child" id="reply-section">
                        <form action="{{ route('admin.messages.update', ['message' => $message->id]) }}" method="POST">
                            ...
                            <div class="col">
                                <div class="row p-3">
                                    <div class="col">
                                        <textarea class="form-control" type="text" name="text_reply" id="reply"
