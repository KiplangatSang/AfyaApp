                        ...
                        <table class="tile table table-bordered p-4 m-3 ">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('admin.diagnoses.create',['visit'=>$visit->id]) }}"><span class="badge badge-dark"><i class="fa fa-file"></i> Make Diagnosis</span></a></td>
                                    <td><a href="{{ route('admin.visits.show',['visit'=>$visit->id]) }}"><i class="fa fa-eye"></i> View</a></td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
