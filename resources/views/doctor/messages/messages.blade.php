            ...
            <section class="message message-container overflow-auto" id="chat-section">
                <div class="parent">
                    ...
                    <div class="container darker">
                        ...
                        <p><strong>{{ $reply->key." " .$message->doctor->user->username}}</strong></p>
                        <p>{{ $reply->message}}</p>
                    ...
                    <div class="container">
                        ...
                        <p><strong>{{$reply->key ." ".$message->patient->user->username }}</strong></p>
                        <p>{{$reply->message }}</p>
                    ...
                    <div class="child" id="reply-section">
                        <form action="{{ route('doctor.messages.update',['message'=> $message->id]) }}" method="POST">
                            @method('PUT') @csrf
                            <label for="reply">
