...
<div class="container-fluid bg-light">
    <section>
        ...
        <div class="container-fluid mt-5">
            ...
            <a href="{{ route('doctor.diagnoses.edit',['diagnosis'=>$diagnosis->id]) }}" class="btn btn-info m-2">Edit</a>
            <a onclick="document.getElementById('diagnosis-delete-form').submit()" class="btn btn-danger m-2">Delete this item</a>
            <form id="diagnosis-delete-form" action="{{ route('doctor.diagnoses.destroy',['diagnosis'=>$diagnosis->id]) }}" class="d-none" method="POST">
                @method("DELETE")
                @csrf
            </form>
        </div>
